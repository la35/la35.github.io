...
categories: js
tags: [js,fullstack,websockets]
image: sockets.png
date:   2020-07-25 20:00:00 -0300
---

Una aplicación de chat usando [WebSockets](https://developer.mozilla.org/es/docs/Web/API/WebSockets_API) y NodeJS. Basado en el [tutorial de Socket.IO](https://socket.io/get-started/chat).

Demo en [la35chat.herokuapp.com](https://la35chat.herokuapp.com/). Código en [GitHub](https://github.com/santiagotrini/hello-websockets).
